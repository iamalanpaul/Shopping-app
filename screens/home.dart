                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          buildColumn1(
                              'assets/images/shirt1.png', 'Roadster', 'Rs 699'),
                          buildColumn1('assets/images/shirt2.png',
                              'Allen Solly', 'Rs 1599'),
                          buildColumn1(
                              'assets/images/shirt3.png', 'Levis', 'Rs 1299'),
                          buildColumn1(
                              'assets/images/dress1.png', 'Roadster', 'Rs 489'),
                          buildColumn1(
                              'assets/images/dress2.png', 'HRX', 'Rs 599'),
                        ],
                      ),
                    ),
                    LineBar(),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          buildContainer1(
                              'assets/images/watches.png', 'Watches', '25%'),
                          buildContainer1(
                              'assets/images/spray.png', 'Perfume', '20%'),
                          buildContainer1(
                              'assets/images/shoes.png', 'Shoes', '50%'),
                          buildContainer1(
                              'assets/images/jeans.png', 'Jeans', '60%'),
                          buildContainer1(
                              'assets/images/sunglasses.png', 'Glasses', '40%'),
                          buildContainer1(
                              'assets/images/shirts.png', 'Shirts', '70%'),
                        ],
                      ),
                    ),
                  ],
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: isSelected
            ? [
                BoxShadow(
                    color: Colors.grey[600], blurRadius: 20, spreadRadius: 2)
              ]
            : [],
      ),
      height: 40,
...
Column buildColumn(String text, {bool isSelected = false}) {
  return Column(
    children: [
      Text(text,
          style: TextStyle(
              color: isSelected ? Colors.cyan : Colors.black, fontSize: 15.0)),
      SizedBox(
        height: 5,
      ),
      if (isSelected == true)
